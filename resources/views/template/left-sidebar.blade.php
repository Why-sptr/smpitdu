...
<li class="nav-item">
    ...
    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="nextevent">Event Yang Akan Datang</a>
            <a class="collapse-item" href="recentevent">Event Yang Telah Berlalu</a>
        </div>
    </div> 
</li>
...
<li class="nav-item">
    ...
    <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom File:</h6>
            <a class="collapse-item" href="informasi">File Informasi PPDB</a>
            <a class="collapse-item" href="seleksi">File Hasil Seleksi PPDB</a>
        </div>
    </div> 
</li>
...
<li class="nav-item">
    ...
    <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="datakepalasekolah">Kepala Sekolah</a>
            <a class="collapse-item" href="datawakilkepala">Wakil Kepala</a>
            ...
            <a class="collapse-item" href="kelas7a">Kelas 7A</a>
            <a class="collapse-item" href="kelas7b">Kelas 7B</a>
            <a class="collapse-item" href="kelas7c">Kelas 7C</a>
            <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Data Kelas 8:</h6>
            <a class="collapse-item" href="kelas8a">Kelas 8A</a>
            <a class="collapse-item" href="kelas8b">Kelas 8B</a>
            <a class="collapse-item" href="kelas8c">Kelas 8C</a>
            <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Data Kelas 9:</h6>
            <a class="collapse-item" href="kelas9a">Kelas 9A</a>
            <a class="collapse-item" href="kelas9b">Kelas 9B</a>
            <a class="collapse-item" href="kelas9c">Kelas 9C</a>
        </div>
    </div> 
</li>
