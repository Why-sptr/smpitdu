                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreprestasiall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/guru/hapuspermanenprestasiall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                            <td>{{ $ds->deleted_at }}</td>
                                                <td><img src="{{ asset('fotojuara/'.$ds->juara->medal)}}" alt="" style="max-height: 151px; max-width: 100px;"></td>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restoreprestasi/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenprestasi/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
