                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoresiswa7ball" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermanensiswa7ball" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                            ...
                                            <th class="text-center" width="300">Dihapus</th>
                                                ...
                                                <th width="100" height="10">Aksi</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" scope="ds">{{ $ds->deleted_at }}</td>
                                                <td>
                                                    <img src="{{ asset('fotosiswa7b/'.$ds->foto)}}" alt="" style="height: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td>{{ $ds->kelas }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restoresiswa7b/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanensiswa7b/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
