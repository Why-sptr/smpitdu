                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/tambahosis" class="btn btn-primary">Tambah Osis</a>
                            <a href="/trashosis" class="btn btn-danger">Sampah</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('fotoosis/'.$ds->foto)}}" alt="" style="max-height: 151px; max-width: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/tampilkandataosis/{{ $ds->id }}'>Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/deleteosis/{{ $ds->id }}'>Hapus</a>
                                                    </div>
                                                </td>
