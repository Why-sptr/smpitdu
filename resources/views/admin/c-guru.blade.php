                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/trashguru" class="btn btn-danger">Sampah</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('fotoguru/'.$ds->foto)}}" alt="" style="max-height: 151px; max-width: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td>{{ $ds->pengampu }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/tampilkandataguru/{{ $ds->id }}'>Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/deleteguru/{{ $ds->id }}'>Hapus</a>
                                                    </div>
                                                </td>
                                </div>
