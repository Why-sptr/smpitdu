                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restorekepalaall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/guru/hapuspermanenkepalaall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" scope="ds">{{ $ds->deleted_at }}</td>
                                                <td>
                                                    <img src="{{ asset('fotokepala/'.$ds->foto)}}" alt="" style="height: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td>{{ $ds->jabatan }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restorekepala/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenkepala/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
