                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreextraall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermanenextraall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Extra</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        <thead>
                                            ...
                                            @endphp
                                            <tr>
                                                <th class="text-center" width="200">Dihapus</th>
                                                <th class="text-center" width="300">Cover</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <img src="{{asset('cover/'.$ds->cover) }}" alt=""  style="height: 100px;"></td>
                                                </td>
                                                <td>{{ $ds->judul }}</td>
                                                <td>{{ $ds->jadwal }}</td>
                                                <td>{{ $ds->jam }}</td>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        ...
                                                        <a class="dropdown-item" href='/restoreextra/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenextra/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
