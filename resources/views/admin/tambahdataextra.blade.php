                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        <form action="/postextra" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="jadwal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                @error('jadwal')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tentang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                @error('tentang')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
