                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        <form action="/insertwalikelas" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="kelas" aria-label="Default select example" value="{{ old('kelas') }}" required>
