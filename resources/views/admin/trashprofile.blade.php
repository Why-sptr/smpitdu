                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreprofileall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/guru/hapuspermanenprofileall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restoreprofile/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenprofile/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
