        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Detail Event</b></h1>
                    <div class="card mb-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Foto</td>
                                                <td><img src="{{ asset('fotoevent/'.$db_smpitdu->foto)}}" alt="" style="height: 100px;"></td>
                                            </tr>
                                            <tr>
                                                <td>Event</td>
                                                <td>{{ $db_smpitdu->event }}</td>
                                            </tr>
                                            <tr>
                                                <td>Peserta</td>
                                                <td>{{ $db_smpitdu->peserta }}</td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal</td>
                                                <td>{{ $db_smpitdu->tanggal }}</td>
                                            </tr>
                                            <tr>
                                                <td>Lokasi</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach($db_smpitdu->images_events as $index)
                                                    <img src="{{asset('images_events/'.$index->image) }}" alt="" style="height: 100px;">
                                                    @endforeach
                                                </td>
                                            </tr>
                                        </tbody>
