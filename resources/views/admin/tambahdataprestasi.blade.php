                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <form action="/insertprestasi" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" style="width: 100%;" name="juara_id" id="juara_id" value="{{ old('juara_id') }}">
                                                <option disabled value>Pilih Juara</option>
                                                @foreach ($db_smpitdu as $item)
                                                <option value="{{ $item->id }}">{{ $item->juara }}</option>
                                                @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="lomba" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ old('lomba') }}">
                                                @error('lomba')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tingkat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ old('tingkat') }}">
                                                @error('tingkat')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
