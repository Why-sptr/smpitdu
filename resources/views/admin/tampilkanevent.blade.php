                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        <form action="/updatedataevent/{{ $db_smpitdu->id }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="event" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $db_smpitdu->event }}">
                                                @error('event')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="peserta" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $db_smpitdu->peserta }}">
                                                @error('peserta')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $db_smpitdu->tanggal }}">
                                                @error('tanggal')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <option selected>{{ $db_smpitdu->status }}</option>
