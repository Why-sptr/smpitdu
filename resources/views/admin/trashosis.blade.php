                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreosisall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermanensemuaosis" class="btn btn-danger">Hapus Semua</a>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Data Osis</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" scope="ds">{{ $ds->deleted_at }}</td>
                                                <td>
                                                    <img src="{{ asset('fotoosis/'.$ds->foto)}}" alt="" style="height: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td  align="center">{{ $ds->jabatan }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restoreosis/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenosis/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
                                            </tr>
