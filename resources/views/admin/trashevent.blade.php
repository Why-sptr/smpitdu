                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreeventall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermaneneventall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/detailevent'>View</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/restoreevent/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenevent/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
