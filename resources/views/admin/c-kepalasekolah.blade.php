                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/tambahkepala" class="btn btn-primary">Tambah Kepala Sekolah</a>
                            <a href="/trashkepala" class="btn btn-danger">Sampah</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" scope="ds">{{ $index + $db_smpitdu->firstItem() }}</td>
                                                <td>
                                                    <img src="{{ asset('fotokepala/'.$ds->foto)}}" alt="" style="max-height: 151px; max-width: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td>{{ $ds->jabatan }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/tampilkandatakepala/{{ $ds->id }}'>Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/deletekepala/{{ $ds->id }}'>Hapus</a>
                                                    </div>
                                                </td>
