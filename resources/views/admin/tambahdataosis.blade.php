                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tambah Data Osis</h6>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        <form action="/insertosis" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="jabatan" aria-label="Default select example" value="{{ old('jabatan') }}" required>
