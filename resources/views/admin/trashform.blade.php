                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <a href="/restoreformall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermanenformall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restoreform/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenform/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
