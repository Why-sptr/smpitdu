        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><b>Karyawan</b></h1>
                    <div class="card mb-4">
                        <div class="card-header">
                            <!-- Button trigger modal -->
                            <a href="/restorekaryawanall" class="btn btn-primary">Kembalikan Semua</a>
                            <a href="/hapuspermanenkaryawanall" class="btn btn-danger">Hapus Semua</a>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <td align="center" scope="ds">{{ $ds->deleted_at }}</td>
                                                <td>
                                                    <img src="{{ asset('fotokaryawan/'.$ds->foto)}}" alt="" style="height: 100px;">
                                                </td>
                                                <td>{{ $ds->nama }}</td>
                                                <td>{{ $ds->jabatan }}</td>
                                                <td class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href='/restorekaryawan/{{ $ds->id }}'>Kembalikan</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href='/hapuspermanenkaryawan/{{ $ds->id }}'>Hapus Permanen</a>
                                                    </div>
                                                </td>
